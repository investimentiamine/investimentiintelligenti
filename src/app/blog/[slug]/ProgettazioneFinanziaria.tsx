...
export function ProgettazioneFinanziaria() {
  return (
    <>
      ...
      <p>
        Quelle sui soldi, sulla vita, sul futuro.
      </p>
      <p>
      ...
      <p>
        In questo articolo voglio raccontarti cosa intendo quando uso l&rsquo;espressione Progettazione Finanziaria. Cosa la distingue e perché ho costruito un metodo che parte dalla vita e non dagli strumenti. Sono arrivato a questa conclusione perché credo sia l&rsquo;unica strada quando in gioco non ci sono solo i soldi, ma il futuro tuo e delle persone che ami.
      </p>

      <h2>Cos&rsquo;è la progettazione finanziaria?</h2>
      <p>
        La <strong>Progettazione Finanziaria</strong> è il mio modo di intendere la pianificazione finanziaria: un metodo di lavoro che parte dalla persona e dalla sua vita — valori, priorità, obiettivi, fragilità — e solo dopo arrivano gli strumenti. È una declinazione specifica della pianificazione finanziaria, costruita per rimettere al centro la persona invece del prodotto. Non un&rsquo;alternativa alla pianificazione, ma una scelta di metodo: l&rsquo;opposto di ciò che fa il sistema bancario tradizionale, che parte dal prodotto che vuole piazzare e cerca di adattarlo al cliente. Se la consulenza tradizionale risponde alla domanda &ldquo;come investo i miei soldi?&rdquo;, la progettazione parte da una domanda diversa:
      </p>
      <p className="text-xl font-medium text-accent text-center italic">
        che cosa vuoi costruire, proteggere o lasciare con questi soldi?
      </p>
      <p>
        Lo dico in modo diretto: nel mio lavoro la prima domanda che faccio a una persona non riguarda il denaro. Non chiedo qual è il portafoglio attuale, non parto dai rendimenti, non chiedo quanto vuole investire. Poiché il denaro è uno strumento, e uno strumento ha senso solo in funzione di ciò che vuoi costruire con esso.
      </p>

      <h2>Siamo un paese con poca consapevolezza finanziaria</h2>
      <p>
        Purtroppo, in Italia non sappiamo abbastanza di finanza e non ci fermiamo abbastanza per pensare al futuro.
      </p>
      <p>
        I numeri sono impietosi: secondo l&rsquo;indagine OCSE/INFE 2023, condotta in 39 Paesi, l&rsquo;Italia si colloca tra gli ultimi posti con un punteggio medio di 10,6 su 20. La Banca d&rsquo;Italia, con l&rsquo;indagine triennale IACOFI, conferma che il livello di conoscenza, comportamenti e atteggiamenti finanziari degli adulti italiani resta basso. Tradotto: gran parte degli italiani non padroneggia concetti quotidiani come inflazione, interesse composto, diversificazione del rischio. E se non hai gli strumenti culturali per capire cosa stai facendo, è naturale affidarsi a chi te li propone senza fare le domande giuste.
      </p>
      <p>
        Il secondo problema è più universale: siamo costantemente di corsa. Negli ultimi decenni ci hanno insegnato che il valore della nostra vita dipende dalla capacità di essere veloci e produttivi. Chi rallenta sembra in ritardo, chi si ferma a riflettere appare meno competitivo. Così, proprio per via di questa corsa, finiamo per perdere di vista le decisioni che richiedono ordine mentale e pazienza. A finire in fondo alla lista sono le domande più importanti: sui soldi, sul futuro, sulla pensione, sui figli — domande che non hanno l&rsquo;urgenza di una bolletta ma che, quando arrivano, arrivano tutte insieme. Questo meccanismo ha un nome preciso: <em>present bias</em>, la tendenza sistematica a dare più peso al presente che al futuro. È proprio questa distorsione che ci porta a rimandare le decisioni importanti ma non urgenti — la progettazione del futuro finanziario è il caso emblematico.
      </p>
      <p>
        Il risultato si vede nei dati. Secondo la Relazione COVIP 2024, solo il 38,3% dei lavoratori italiani è iscritto a una forma di previdenza complementare, e considerando solo chi versa contributi nell&rsquo;anno la percentuale scende al 27,6%. In altre parole: due lavoratori su tre non stanno costruendo nulla per integrare la propria pensione futura, in un Paese in cui la pensione pubblica sarà progressivamente più bassa. Sull&rsquo;altro fronte, secondo le elaborazioni FABI su dati Banca d&rsquo;Italia, le famiglie italiane hanno una ricchezza finanziaria di oltre 6.000 miliardi a fine 2024 — ma circa 1.593 miliardi restano parcheggiati su conti correnti, dove l&rsquo;inflazione li erode anno dopo anno. Dietro questi numeri c&rsquo;è quasi sempre la stessa storia: persone che non si sono mai fermate abbastanza per progettare con metodo.
      </p>
      ...
      <p>
        La prima fase è la più delicata, ed è quella che il sistema tradizionale tende a saltare. Serve a fare chiarezza su tre cose: i tuoi valori, le tue priorità, i tuoi desideri di vita. Non parliamo di portafoglio, non di rendimenti. Parliamo di te: di come vivi adesso, come vorresti vivere domani, cosa ti preoccupa, cosa desideri per chi ami. Molte persone si accorgono di non aver mai veramente pensato a queste cose — non perché siano superficiali, ma perché nessuno gli ha mai dato il tempo per farlo.
      </p>

      <h3>Fase 2 — Visualizzazione (con il Render Finanziario)</h3>
      <p>
        Nella seconda fase entra in gioco lo strumento a cui tengo di più: il <strong>Render Finanziario</strong>, una tavola grafica che ho creato e che trasforma in forma visibile la tua vita futura — tappe, priorità, obiettivi vicini e lontani, fragilità da proteggere, persone a cui tieni. Funziona come il render di un architetto: quando un architetto sta per costruire una casa per una famiglia, non parte dai mattoni, parte dal render, un&rsquo;immagine prospettica di come sarà la casa una volta costruita. Solo quando la famiglia vede il render, quella casa smette di essere un&rsquo;idea astratta e diventa qualcosa di concreto, che può approvare, modificare, far propria. Solo a quel punto si parla di materiali. Il Render Finanziario fa la stessa cosa con la tua vita: trasforma in immagine ciò che spesso resta solo un pensiero confuso.
      </p>
      <p>
      ...
      <p>
        Solo dopo aver capito chi sei, cosa vuoi raggiungere e cosa vuoi proteggere, ha senso parlare di strumenti. Nella terza fase traduciamo gli obiettivi emersi in scelte operative: allocazione efficace dei risparmi, pianificazione patrimoniale, investimenti coerenti, copertura dei rischi, ottimizzazione fiscale, previdenza, successione. È qui che si parla degli strumenti utili a soddisfare gli obiettivi di cui mi hai parlato. Ma se ne parla dopo aver fatto le prime due fasi. Gli strumenti diventano materiali al servizio di un progetto, non un fine in sé.
      </p>

      <h3>Fase 4 — Monitoraggio</h3>
      <p>
        Una volta costruito il progetto, inizia la parte più importante: accompagnarlo nel tempo. La vita finanziaria non è un documento statico da chiudere in un cassetto, è un organismo vivo. Cambiano i mercati, le leggi, i bisogni, le famiglie. Un figlio cresce, un genitore invecchia, un&rsquo;eredità arriva. Per questo una progettazione ha bisogno di monitoraggio, confronto e adattamento. Inoltre, c&rsquo;è una cosa che reputo fondamentale: il cointeresse. Il valore del mio lavoro dipende dalla soddisfazione della persona nel tempo.
      </p>

      <h2>La progettazione cambia con la fase di vita: una mappa operativa</h2>
      <p>
        Un altro principio spesso dimenticato è questo: i bisogni finanziari cambiano con la fase della vita in cui ci si ritrova. Quello che ha senso a 30 anni non è quello che ha senso a 45 o a 55. Eppure il sistema tradizionale tende a proporre prodotti simili a chiunque. Ecco una mappa sintetica delle quattro grandi fasi della vita finanziaria adulta. Riconoscere in quale fase sei è il primo passo per capire da dove deve partire la tua progettazione:
      </p>
      ...
      <ol>
        <li><strong>Fermati. Davvero.</strong> Trova un&rsquo;ora vera, non venti minuti rubati tra una riunione e l&rsquo;altra. Spegni il telefono. Foglio bianco e penna. Niente schermi. È l&rsquo;investimento con il maggior rendimento, non una perdita di tempo.</li>
      ...
      <p>
        Lo dico spesso: il mio obiettivo non è che tu diventi un esperto di finanza, ma che tu diventi un esperto della <em>tua</em> finanza. Per troppo tempo il rapporto tra noi italiani e il denaro è stato costruito su un&rsquo;asimmetria: noi che non sapevamo, e qualcuno dall&rsquo;altra parte che ci proponeva qualcosa senza darci il tempo di capirla. Il risultato è una generazione che ha lavorato tanto, risparmiato tanto, e oggi si ritrova con un patrimonio frammentato, fermo, mal allineato a quello che vorrebbe davvero costruire o proteggere. La progettazione finanziaria è il tentativo di invertire quell&rsquo;asimmetria: mettere te al centro, non i prodotti. Fermarsi prima di scegliere. Disegnare il render della tua vita prima di scegliere i materiali.
      </p>
      ...
      <p>
        Se sei stanco di sentirti chiedere quanto vuoi investire prima di essere stato ascoltato, se vuoi tornare a pensare al denaro come strumento di vita e non come fine in sé, allora forse hai bisogno di iniziare proprio dal Render Finanziario.
      </p>
