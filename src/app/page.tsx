      ...
      <section className="relative py-28 lg:py-40 px-6 min-h-[800px] flex flex-col items-center justify-center">
        ...
        <div className="bg-white/95 backdrop-blur-sm rounded-[40px] shadow-2xl p-8 lg:p-12 max-w-6xl w-full grid sm:grid-cols-2 lg:grid-cols-4 gap-8 relative z-10 mb-16 text-center">
          ...
          <div className="flex flex-col items-center h-full">
            ...
            <p className="text-accent/70 text-sm leading-relaxed mt-auto">Liberi di scegliere gli strumenti più adatti a te sul mercato.</p>
          </div>
          <div className="flex flex-col items-center h-full">
            <div className="bg-blue-600 text-white p-5 rounded-full mb-6 shadow-[0_8px_20px_rgba(37,99,235,0.4)]">
              <Eye size={32} />
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 items-stretch">
            <div className="card text-left flex flex-col h-full hover:-translate-y-1 transition-transform">
              ...
              <p className="text-sm text-accent/70 mb-6 leading-relaxed flex-grow">Se cercate un consulente finanziario preparato, affidabile ed appassionato del proprio lavoro, allora dovete rivolgervi al dottor Amine Alahiyane. È stato capace di spiegarmi concetti complessi in modo chiaro e comprensibile, facendomi sentire a mio agio nel prendere decisioni finanziarie...</p>
            ...
            <div className="card text-left flex flex-col h-full hover:-translate-y-1 transition-transform">
              ...
              <p className="text-sm text-accent/70 mb-6 leading-relaxed flex-grow">Consulente molto preparato che consiglia e spiega in modo chiaro e semplice anche a clienti che non sono esperti di finanza. Adotta strategie di diversificazione degli investimenti con obiettivi personalizzati secondo le esigenze del cliente. Consiglio soprattutto per la sua grande disponibilità.</p>
              <a href="https://www.google.com/search?sca_esv=3d3edac27adaa913&q=Studio+di+Consulenza+Finanziaria+-+Dott.+Amine+Alahiyane&si=AMgyJEtREmoPL4P1I5IDCfuA8gybfVI2d5Uj7QMwYCZHKDZ-EyBsvUYGwu4thxx4G9BXZYqGaaL7xnFAe7UAVo-ZboqTwFXUikp2zZSqRu8011dY33Nu0r4%3D&uds=AOm0WdE9G6E6l0NV56fgnfyGXriKGPywmHQZIZGoWE2du7ZMqJpuvF0EB880GkKrucaZgL5zCcMLlPM18eOMpVp8zWfH3GdoNFhiOTK0xX-CelIiY_qGbtDCoYXfxqI7OpFIixAchuQTuu3YY_6K2Upp04DpdWNhBdonRGmP7iOYwHDBvWK7pAw&sa=X&ved=2ahUKEwj87Z2ovuyQAxXz9rsIHctmBxsQ3PALegQIRBAF&biw=1512&bih=861&dpr=2" target="_blank" rel="noopener noreferrer" className="text-blue-600 text-sm font-semibold hover:underline inline-flex items-center gap-1 mt-auto">Continua a leggere &rarr;</a>
            </div>
            <div className="card text-left flex flex-col h-full hover:-translate-y-1 transition-transform">
              <div className="flex gap-1 text-yellow-400 mb-5">
              ...
              <p className="text-sm text-accent/70 mb-6 leading-relaxed flex-grow">Professionale, serio e molto competente oltre ad essere molto disponibile. Si prende letteralmente cura del suo cliente. Ti segue passo dopo passo con un approccio personalizzato, dimostrando sempre competenza, chiarezza e correttezza. Posso dirmi completamente soddisfatta.</p>
              <a href="https://www.google.com/search?sca_esv=3d3edac27adaa913&q=Studio+di+Consulenza+Finanziaria+-+Dott.+Amine+Alahiyane&si=AMgyJEtREmoPL4P1I5IDCfuA8gybfVI2d5Uj7QMwYCZHKDZ-EyBsvUYGwu4thxx4G9BXZYqGaaL7xnFAe7UAVo-ZboqTwFXUikp2zZSqRu8011dY33Nu0r4%3D&uds=AOm0WdE9G6E6l0NV56fgnfyGXriKGPywmHQZIZGoWE2du7ZMqJpuvF0EB880GkKrucaZgL5zCcMLlPM18eOMpVp8zWfH3GdoNFhiOTK0xX-CelIiY_qGbtDCoYXfxqI7OpFIixAchuQTuu3YY_6K2Upp04DpdWNhBdonRGmP7iOYwHDBvWK7pAw&sa=X&ved=2ahUKEwj87Z2ovuyQAxXz9rsIHctmBxsQ3PALegQIRBAF&biw=1512&bih=861&dpr=2" target="_blank" rel="noopener noreferrer" className="text-blue-600 text-sm font-semibold hover:underline inline-flex items-center gap-1 mt-auto">Continua a leggere &rarr;</a>
            </div>
          </div>
        </div>
